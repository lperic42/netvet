...
<body>
    <div id="app">
        ...
        <div class="jumbotron text-center" style="height: 100vh; display: flex; flex-direction: column; justify-content: center; align-items: center;">
            ...
            <hr>
            <a href="" class="lead" style="color: #fff; text-decoration: none; font-weight: 400; font-size: 20px; padding: 10px 15px; background-color: rgb(57, 159, 252); border-radius: 10px;">
                Savjeti
            </a>
        </div>
